...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture("../../Utilities/textures/Plastic.jpg", "bottle");
...
//Add and configure lighting in our scene 

void SceneManager::SetupSceneLights()
{
	m_pShaderManager->setVec3Value("light.position", 1.0f, 2.0f, 1.0f);
	m_pShaderManager->setVec3Value("light.ambient", 0.1f, 0.1f, 0.1f);
	m_pShaderManager->setVec3Value("light.diffuse", 0.7f, 0.7f, 0.7f);
	m_pShaderManager->setVec3Value("light.specular", 1.0f, 1.0f, 1.0f);
...
void SceneManager::RenderScene()
{
	...
	// WHEN I CALL THIS FOR MY LIGHTS I GET A BLACK SCREEN, I HAVE TRIED
	// EVERYTHING TO FIX
	// 
	//SetupSceneLights();
	...
	positionXYZ = glm::vec3(-1.5f, 0.25f, 0.0f);
	SetTransformations(scaleXYZ, 0.0f, 0.0f, 0.0f, positionXYZ);
	//SetShaderColor(0.3f, 0.3f, 0.8f, 1.0f);
	...
	positionXYZ = glm::vec3(-1.5f, 1.2f, 0.0f);
	SetTransformations(scaleXYZ, 0.0f, 0.0f, 0.0f, positionXYZ);
	//SetShaderColor(0.3f, 0.3f, 0.8f, 1.0f);
	SetShaderTexture("cone");

	m_basicMeshes->DrawTaperedCylinderMesh();  // use DrawPyramidMesh() if that's your actual function
	...
	//Foam piece in front
	scaleXYZ = glm::vec3(0.3f, 1.5f, 0.5f);
	positionXYZ = glm::vec3(-1.2f, 0.25f, 1.0f);
	SetTransformations(scaleXYZ, 0.0f, 0.0f, 0.0f, positionXYZ);
	SetShaderColor(0.3f, 0.3f, 0.8f, 1.0f);
	//SetShaderTexture("");
	...
	positionXYZ = glm::vec3(0.5f, 0.25f, 0.75f);
	SetTransformations(scaleXYZ, 0.0f, 0.0f, 0.0f, positionXYZ);
	...
	//Opening for candle 
	scaleXYZ = glm::vec3(0.9f, 0.1f, 1.0f);
	positionXYZ = glm::vec3(0.5f, 2.66f, 0.75f);
	SetTransformations(scaleXYZ, 0.0f, 0.0f, 0.0f, positionXYZ);
